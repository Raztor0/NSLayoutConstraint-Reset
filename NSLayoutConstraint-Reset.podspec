...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/NSLayoutConstraint-Reset"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Razvan Bangu" => "razvan.bangu@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/NSLayoutConstraint-Reset.git", :tag => s.version.to_s }
  ...
  s.resource_bundles = {
    'NSLayoutConstraint-Reset' => ['Pod/Assets/*.png']
  }
